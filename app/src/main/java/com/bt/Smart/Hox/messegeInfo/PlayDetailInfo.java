...
public class PlayDetailInfo {
    ...
    private int                  code;
    private List<PlaydetailBean> playdetail;
    ...
    public List<PlaydetailBean> getPlaydetail() {
        return playdetail;
    }

    public void setPlaydetail(List<PlaydetailBean> playdetail) {
        this.playdetail = playdetail;
    }

    public static class PlaydetailBean {
        /**
         * sys_org_code : A03
