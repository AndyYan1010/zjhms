...
public class MyOverScrollView extends ScrollView {
    ...
    public MyOverScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyOverScrollView setOnReboundEndListener(OnReboundEndListener onReboundEndListener) {
        this.mOnReboundEndListener = onReboundEndListener;
        return this;

    }

    public MyOverScrollView setEnableTopRebound(boolean enableTopRebound) {
        this.mEnableTopRebound = enableTopRebound;
        return this;
    }

    public MyOverScrollView setEnableBottomRebound(boolean mEnableBottomRebound) {
